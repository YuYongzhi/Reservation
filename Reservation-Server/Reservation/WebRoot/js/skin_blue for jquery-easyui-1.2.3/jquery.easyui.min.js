...
pp.panel("header").find('.panel-title').addClass('accordion-font-color');
...
if(opts.height!="auto"){
var _394=_38c-_38e.children("div.datagrid-header").outerHeight(true)-_38e.children("div.datagrid-footer").outerHeight(true)-wrap.children("div.datagrid-toolbar").outerHeight(true)-wrap.children("div.datagrid-searchbar").outerHeight(true)-wrap.children("div.datagrid-pager").outerHeight(true);
...
$("div.datagrid-toolbar",_3b4).remove();
	...
	$("div.datagrid-searchbar",_3b4).remove();
	...
	if(opts.searchbar){
		...
		var tb=$("<div class=\"datagrid-searchbar\"></div>").prependTo(_3b4);
		...
		if(forms){
			...
			var submitButton = $("<a href=\"javascript:void(0)\" style=\"margin-right:20px;float:right;margin-top:6px;\">Search</a>");
			...
			submitButton.linkbutton({plain:false,iconCls:'icon-search'}).click(function(){
				$(_3b3).datagrid("load",getSearchValue()); 
			});
...
var _4bbs=$("<input type=\"text\">").appendTo(_4b9s);
...
var ops = $(_4bf).combobox("options");
	if(ops.multiple){
		var vals = $(_4bf).combobox("getValues");
		if(vals){
...
var ops = $(_4c0).combobox("options");
	if(ops.multiple){
		if(_4c1){
			return $(_4c0).combobox("setValues",_4c1.split(","));
		}
		return;
	}else{
		return $(_4c0).combobox("setValue",_4c1);
	}
