...
import com.reservation.act.MainFragmentActivity;
...
public class ActivityUtils {
	...
	public static final void toHomeAct(Context context) {
		to(context, MainFragmentActivity.class);
	}
	 ...
	 * 
	 */
	public static void createShortcut(Context context, int logo, String name, Class<?> cls) {
